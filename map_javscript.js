...
function initialize() {
  ...
  //Info Window Content 
  var endSprints = '<p> End for the sprint races. </p>'
  ...
  var basinInfo = '<p> <h1> Basin Rapid </h1> <h3> An overview  </h3> <p> Basin Rapid is the second of the three large rapids on the Penobscot. <div class="video-container"> <iframe width="640" height="360" src="https://www.youtube.com/embed/iMQiI91PdYs?autoplay=1" frameborder="0" allowfullscreen></iframe> </div> <p>'; 
  ...
  var gLeftInfo = '<p> <div style="width: 100%; display: table;"> <div style="display: table-row">  <div style="width: 600px; display: table-cell;"> <b> The (main) Left Channel </b>    <a target="_blank" href="http://www.isaac26.com/uploads/leftside.jpg" > <img src="http://www.isaac26.com/uploads/leftside.jpg" height=225 width=300> </img>  </a>   </div> <div style="display: table-cell;">  <b> The far left channel  </b> <div>  <iframe width="350" height="198" src="https://www.youtube.com/embed/y0MflUM7vyE?rel=0&t=03s" frameborder="0" allowfullscreen></iframe></div> <div id="video-container"><iframe width="350" height="197" src="https://www.youtube.com/embed/rZ_-G3ycNmw" frameborder="0" allowfullscreen></iframe> </div> <div> The far left channel can generally be run at medium to high flows with some rock dodging and bracing (5+ ft on the Eddington gage). However, lower then 5ft and it becomes very difficult for larger boats to navigate down.     </div> </div> </div>  <p>';
  var veazieRight = '<p> <b> Veazie Right Channel </b> <div id="video-container"> <iframe width="390" height="219" src="https://www.youtube.com/embed/2A4nEaegNsU?rel=0" frameborder="0" allowfullscreen></iframe> </div>  </p>'
  ...
  var baseLeft = '<p> <b> The Center left </b> <b> Far left rapids </b> <div id="video-container"> <iframe width="560" height="315" src="https://www.youtube.com/embed/wjOxc4mHZbk" frameborder="0" allowfullscreen></iframe> </div> <p> <p> Coming soon! </p> <p> Do you have videos/photos/descriptions of the left and far left lines of Basin Rapid? Please send them to igodfried@isaac26.com. You will be credited.  </p>';
  ...
  arrayLocation[3] = new google.maps.LatLng(44.919951, -68.634031); //3 4 5 7 8 9
